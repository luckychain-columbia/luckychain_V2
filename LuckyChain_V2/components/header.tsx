...
export default function Header() {
  return (
    <section className="relative">
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-4 py-8 max-w-screen-xl">
        <nav className="flex items-center justify-between flex-wrap gap-2 md:gap-0 min-w-0">
          <Link
            href="/"
