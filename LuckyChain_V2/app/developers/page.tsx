                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        ...
                        Ethereum smart contracts. It enables users to create and
                        participate in provably fair lotteries with transparent
                        winner selection and automatic prize distribution. The
                        platform is fully decentralized, requiring no central
                    ...
                    <div>
                      ...
                      <div className="glass p-6 rounded-xl border border-border/40">
                        ...
                        <ol className="space-y-2 text-muted-foreground ml-6 list-decimal">
                          ...
                          <li>
                            <strong>Export ABI:</strong> Automatically exported
                            to frontend after compilation
                          </li>
                          <li>
                    ...
                    <div>
                      ...
                      <div className="glass p-6 rounded-xl border border-border/40">
                        <ol className="space-y-2 text-muted-foreground ml-6 list-decimal">
                          ...
                          <li>
                            <strong>Test on Sepolia:</strong> Deploy contract to
                    ...
                    <div>
                      ...
                      <div className="glass p-6 rounded-xl border border-border/40">
                        <ul className="space-y-2 text-muted-foreground ml-6 list-disc">
                          ...
                          <li>
                            <strong>Gas Optimization:</strong> Measure gas costs
                            for all functions
                          </li>
                        </ul>
                      </div>
                    ...
                    <div>
                      ...
                      <div className="glass p-6 rounded-xl border border-border/40">
                        <ul className="space-y-2 text-muted-foreground ml-6 list-disc">
                          ...
                          <li>
                            <strong>Integration:</strong> Test Web3 integration,
                            contract interactions, transaction handling
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="glass p-6 rounded-xl border border-border/40 mb-4">
                        ...
                        <ol className="space-y-3 text-muted-foreground ml-6 list-decimal">
                          ...
                          <li>
                            <strong>Blockchain Layer:</strong> Ethereum network
                            (or EVM-compatible chain) for transaction execution
                            and state storage
                          </li>
                        </ol>
                      </div>
                          ...
                          <div className="flex items-start gap-4">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-muted-foreground">
                                ...
                                Contract validates transaction → Funds added to
                                prize pool → Participant address stored
                              </p>
                            </div>
                          </div>
                          <div className="flex items-start gap-4">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-muted-foreground">
                                ...
                                Prizes distributed automatically → Finalization
                    ...
                    <div>
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div className="glass p-4 rounded-xl border border-green-500/30 bg-green-500/10">
                          ...
                          <p className="text-sm text-muted-foreground">
                            All funds locked in contract until finalization. No
                            owner privileges or admin functions. Immutable
                            contract code.
                          </p>
                        </div>
                        <div className="glass p-4 rounded-xl border border-blue-500/30 bg-blue-500/10">
                          ...
                          <p className="text-sm text-muted-foreground">
                            ...
                            storage using mappings. Minimal external calls. RPC
                            call caching reduces network requests by ~73%.
                          </p>
                        </div>
                    ...
                    <div>
                      ...
                      <div className="glass p-5 rounded-xl border border-border/40 mb-4">
                        <ul className="space-y-2 text-muted-foreground ml-7 list-disc">
                          ...
                          <li>
                            <strong>Randomness:</strong> keccak256 hash of block
                            data
                          </li>
                          <li>
                    ...
                    <div>
                      ...
                      <div className="glass p-6 rounded-xl border border-border/40">
                        <p className="text-muted-foreground mb-4">
                          ...
                          contract is the core of the platform. Key components:
                        </p>
                        <ul className="space-y-2 text-muted-foreground ml-6 list-disc">
                          <li>
                      ...
                      <div className="space-y-4">
                        <div className="glass p-5 rounded-xl border border-border/40">
                          ...
                          <p className="text-sm text-muted-foreground mb-2">
                            ...
                            Validates inputs and stores raffle data in contract
                            storage.
                          </p>
                        ...
                        <div className="glass p-5 rounded-xl border border-border/40">
                          ...
                          <p className="text-sm text-muted-foreground mb-2">
                            ...
                            raffle is active, checks max tickets limit, enforces
                        ...
                        <div className="glass p-5 rounded-xl border border-border/40">
                          ...
                          <p className="text-xs text-muted-foreground">
                            <strong>Access Control:</strong> Anyone can finalize
                            expired lotteries, only creator can finalize early
                            when max tickets reached
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="glass p-6 rounded-xl border border-purple-500/30 bg-purple-500/10">
                        ...
                        <ul className="space-y-2 text-sm text-muted-foreground ml-6 list-disc">
                          ...
                          <li>
                            Purpose: Incentivizes finalization, covers gas costs
                          </li>
                        </ul>
                      </div>
                    </div>
                      ...
                      <div className="space-y-4">
                        <div className="glass p-5 rounded-xl border border-border/40">
                          ...
                          <p className="text-xs text-muted-foreground">
                            ...
                            load, account change detection, provider switching,
                        ...
                        <div className="glass p-5 rounded-xl border border-border/40">
                          ...
                          <p className="text-xs text-muted-foreground">
                            <strong>Features:</strong> Real-time updates, ticket
                            count input, winner display, finalization button,
                            progress tracking
                          </p>
                        </div>
                        <div className="glass p-5 rounded-xl border border-border/40">
                          ...
                          <p className="text-xs text-muted-foreground">
                            ...
                            price, end date, number of winners, creator fee, max
                            entrants
                          </p>
                        </div>
                      </div>
                    ...
                    <div>
                      ...
                      <div className="glass p-6 rounded-xl border border-border/40">
                        ...
                        <ul className="space-y-2 text-muted-foreground ml-6 list-disc">
                          ...
                          <li>
                            <strong>useMemo:</strong> Computed values (contract
                            instance, filtered lotteries)
                          </li>
                          <li>
                      ...
                      <div className="space-y-4">
                        <div className="glass p-6 rounded-xl border border-blue-500/30 bg-blue-500/10">
                          ...
                          <p className="text-sm text-muted-foreground mb-4">
                            Intelligent caching system reduces RPC calls by ~73%
                            for completed raffles:
                          </p>
                          ...
                          <p className="text-sm text-muted-foreground mb-3">
                            ...
                            invalidated after creating raffles, buying tickets,
                            or finalizing raffles. Expired entries are cleaned
                            up every 30 seconds.
                          </p>
                          <p className="text-sm text-muted-foreground">
                        ...
                        <div className="glass p-5 rounded-xl border border-border/40">
                          ...
                          <p className="text-sm text-muted-foreground mb-2">
                            ...
                            re-renders. Expensive calculations are cached using
                            useMemo.
                          </p>
                          <p className="text-xs text-muted-foreground">
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div className="glass p-4 rounded-xl border border-yellow-500/30 bg-yellow-500/10">
                          ...
                          <p className="text-sm text-muted-foreground">
                            ...
                            connected, the app displays mock data to demonstrate
                            functionality. This allows the app to work in demo
                            mode.
                          </p>
                        </div>
                        <div className="glass p-4 rounded-xl border border-yellow-500/30 bg-yellow-500/10">
