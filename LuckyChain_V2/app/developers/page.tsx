    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <section className="relative">
        <div className="relative container mx-auto px-4 py-20">
          <nav className="flex items-center justify-between mb-8 md:mb-12 flex-wrap gap-2 md:gap-0">
            <Link href="/" className="flex items-center gap-2 md:gap-3 hover:opacity-80 transition-opacity">
              ...
              <span className="text-xl md:text-3xl font-bold tracking-tight text-white relative z-10">
                LuckyChain
              </span>
            </Link>
              ...
              <Tabs defaultValue="overview" className="w-full">
                ...
                <TabsContent value="overview" className="space-y-6">
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                          <div className="glass p-4 rounded-xl border border-primary/30">
                            <div className="flex items-center gap-2 mb-2">
                              ...
                              <span className="font-semibold">Decentralized Architecture</span>
                            </div>
                            <p className="text-sm text-muted-foreground">
                              Built on Ethereum smart contracts with no central authority
                            </p>
                          </div>
                          <div className="glass p-4 rounded-xl border border-secondary/30">
                            <div className="flex items-center gap-2 mb-2">
                              <CheckCircle className="h-5 w-5 text-secondary" />
                              <span className="font-semibold">Provably Fair Randomness</span>
                            </div>
                            <p className="text-sm text-muted-foreground">
                              On-chain randomness using block data and keccak256 hashing
                            </p>
                          </div>
                          <div className="glass p-4 rounded-xl border border-accent/30">
                            ...
                            <p className="text-sm text-muted-foreground">
                              Instant prize distribution via smart contract execution
                            </p>
                          </div>
                          <div className="glass p-4 rounded-xl border border-purple-500/30">
                            <div className="flex items-center gap-2 mb-2">
                              <CheckCircle className="h-5 w-5 text-purple-500" />
                              <span className="font-semibold">Gas Fee Coverage</span>
                            </div>
                            <p className="text-sm text-muted-foreground">
                  ...
                  <Card className="glass-strong glow-border p-8 space-y-6">
                    ...
                    <div className="space-y-6">
                      <div>
                        <h3 className="font-semibold text-lg mb-3">Smart Contract Deployment</h3>
                        <div className="glass p-6 rounded-xl border border-border/40">
                          ...
                          <ol className="space-y-2 text-muted-foreground ml-6 list-decimal">
                            <li>
                              <strong>Compile:</strong> <code className="bg-muted px-2 py-1 rounded">npm run compile</code>
                            </li>
                            <li>
                              <strong>Deploy:</strong> <code className="bg-muted px-2 py-1 rounded">npm run deploy -- --network sepolia</code>
                            </li>
                            <li>
                              <strong>Export ABI:</strong> Automatically exported to frontend after
                              compilation
                            </li>
                            <li>
                              <strong>Update Environment:</strong> Contract address synced to{" "}
                      ...
                      <div>
                        <h3 className="font-semibold text-lg mb-3">Frontend Deployment</h3>
                        <div className="glass p-6 rounded-xl border border-border/40">
                          <p className="text-muted-foreground mb-3">
                          ...
                          <ol className="space-y-2 text-muted-foreground ml-6 list-decimal">
                            <li>
                              <strong>Build:</strong> <code className="bg-muted px-2 py-1 rounded">npm run build</code>
                            </li>
                            <li>
                              <strong>Deploy:</strong> Automated via GitHub Actions on push to main
                            </li>
                            <li>
                      ...
                      <div>
                        ...
                        <div className="glass p-6 rounded-xl border border-border/40">
                          <ol className="space-y-2 text-muted-foreground ml-6 list-decimal">
                            <li>
                              <strong>Install Dependencies:</strong> <code className="bg-muted px-2 py-1 rounded">npm install</code>
                            </li>
                            <li>
                              <strong>Start Dev Server:</strong> <code className="bg-muted px-2 py-1 rounded">npm run dev</code>
                            </li>
                            <li>
                              <strong>Connect Wallet:</strong> Use MetaMask or compatible wallet
                            </li>
                            <li>
                              <strong>Test on Sepolia:</strong> Deploy contract to Sepolia testnet for
                              testing
                            </li>
                          </ol>
                        </div>
                  ...
                  <Card className="glass-strong glow-border p-8 space-y-6">
                    <div className="flex items-center gap-3">
                      ...
                      <h2 className="text-3xl font-bold">Testing & Verification</h2>
                    </div>

                    <div className="space-y-6">
                      <div>
                        <h3 className="font-semibold text-lg mb-3">Smart Contract Testing</h3>
                        <div className="glass p-6 rounded-xl border border-border/40">
                          <ul className="space-y-2 text-muted-foreground ml-6 list-disc">
                            <li>
                              <strong>Manual Testing:</strong> Deploy to Sepolia testnet and test all
                              functions
                            </li>
                            <li>
                            ...
                            <li>
                              <strong>Gas Optimization:</strong> Measure gas costs for all functions
                            </li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <div>
                        <h3 className="font-semibold text-lg mb-3">Frontend Testing</h3>
                        <div className="glass p-6 rounded-xl border border-border/40">
                          <ul className="space-y-2 text-muted-foreground ml-6 list-disc">
                            <li>
                            ...
                            <li>
                              <strong>UI/UX:</strong> Test responsive design, loading states, error messages
                            </li>
                            <li>
                              <strong>Integration:</strong> Test Web3 integration, contract interactions,
                  ...
                  <Card className="glass-strong glow-border p-8 space-y-6 border-primary/30 bg-primary/5">
                    ...
                    <div className="space-y-4">
                      ...
                      <ul className="space-y-2 text-muted-foreground ml-6 list-disc">
                        ...
                        <li>Comprehensive documentation and code organization</li>
                      </ul>
                    </div>
                  </Card>
                </TabsContent>
                ...
                <TabsContent value="architecture" className="space-y-6">
                  <Card className="glass-strong glow-border p-8 space-y-6">
                    ...
                    <div className="space-y-6">
                      <div>
                        ...
                        <div className="glass p-6 rounded-xl border border-border/40 mb-4">
                          <p className="text-muted-foreground mb-4">
                            LuckyChain follows a decentralized architecture with three main components:
                          </p>
                          <ol className="space-y-3 text-muted-foreground ml-6 list-decimal">
                            ...
                            <li>
                              ...
                              interface and Web3 integration
                            </li>
                            <li>
                              <strong>Blockchain Layer:</strong> Ethereum network (or EVM-compatible chain)
                              for transaction execution and state storage
                            </li>
                          </ol>
                        </div>
                      </div>
                        ...
                        <div className="glass p-6 rounded-xl border border-border/40">
                          <div className="space-y-4">
                            ...
                            <div className="flex items-start gap-4">
                              ...
                              <div>
                                <h4 className="font-semibold mb-1">Buy Tickets</h4>
                                <p className="text-sm text-muted-foreground">
                                  Participant sends ETH with ticket purchase → Contract validates
                                  transaction → Funds added to prize pool → Participant address stored
                                </p>
                              </div>
                            </div>
                            <div className="flex items-start gap-4">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                  ...
                                  reward paid to finalizer (if expired)
                                </p>
                              </div>
                            </div>
                          </div>
                      ...
                      <div>
                        <h3 className="font-semibold text-lg mb-3">Key Design Decisions</h3>
                        <div className="grid md:grid-cols-2 gap-4">
                          <div className="glass p-4 rounded-xl border border-green-500/30 bg-green-500/10">
                            ...
                            <p className="text-sm text-muted-foreground">
                              All funds locked in contract until finalization. No owner privileges or
                              admin functions. Immutable contract code.
                            </p>
                          </div>
                          ...
                          <div className="glass p-4 rounded-xl border border-purple-500/30 bg-purple-500/10">
                            ...
                            <p className="text-sm text-muted-foreground">
                              On-chain randomness prevents manipulation. Verifiable winner selection.
                          ...
                          <div className="glass p-4 rounded-xl border border-orange-500/30 bg-orange-500/10">
                            ...
                            <p className="text-sm text-muted-foreground">
                              No central authority. Anyone can finalize expired lotteries. Reward system
                ...
                <TabsContent value="contract" className="space-y-6">
                  <Card className="glass-strong glow-border p-8 space-y-6">
                    ...
                    <div className="space-y-6">
                      <div>
                        <h3 className="font-semibold text-lg mb-3">Contract Specifications</h3>
                        <div className="glass p-5 rounded-xl border border-border/40 mb-4">
                          <ul className="space-y-2 text-muted-foreground ml-7 list-disc">
                            ...
                            <li>
                              <strong>Network:</strong> Ethereum (or EVM-compatible chains)
                            </li>
                            <li>
                              <strong>Randomness:</strong> keccak256 hash of block data
                            </li>
                            <li>
                              <strong>Winner Selection:</strong> Fisher-Yates shuffle algorithm using indices
                            </li>
                            <li>
                              <strong>Fund Safety:</strong> All funds are locked in the contract until
                              distribution
                            </li>
                          </ul>
                        </div>
                        ...
                        <div className="space-y-4">
                          <div className="glass p-5 rounded-xl border border-border/40">
                            ...
                            <p className="text-xs text-muted-foreground">
                              ...
                              number of winners, creator fee, max tickets, allow multiple entries
                            </p>
                          </div>
                          <div className="glass p-5 rounded-xl border border-border/40">
                            <h4 className="font-semibold mb-2">
                          ...
                          <div className="glass p-5 rounded-xl border border-border/40">
                            ...
                            <p className="text-xs text-muted-foreground">
                              <strong>Access Control:</strong> Anyone can finalize expired lotteries,
                              only creator can finalize early when max tickets reached
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        <h3 className="font-semibold text-lg mb-3">Randomness Implementation</h3>
                        <div className="glass p-6 rounded-xl border border-border/40">
                          <p className="text-muted-foreground mb-3">
                            Winner selection uses on-chain randomness combining multiple sources:
                          </p>
  ...
  abi.encodePacked(
    ...
    i
                          ...
                          <ul className="space-y-2 text-sm text-muted-foreground ml-6 list-disc">
                            <li>
                              <strong>block.timestamp:</strong> Current block timestamp (unpredictable)
                            </li>
                            <li>
                          ...
                          <p className="text-muted-foreground mt-3 text-sm">
                            The Fisher-Yates shuffle algorithm ensures no duplicate winners by maintaining
                            an index array and swapping selected indices.
                          </p>
                        </div>
                      </div>

                      <div>
                        <h3 className="font-semibold text-lg mb-3">Finalization Reward System</h3>
                        <div className="glass p-6 rounded-xl border border-purple-500/30 bg-purple-500/10">
                          <p className="text-muted-foreground mb-3">
                            For expired lotteries, the contract pays a reward to the finalizer:
                          </p>
                          <code className="block bg-muted p-4 rounded-lg text-sm font-mono mb-3">
                          ...
                          <ul className="space-y-2 text-sm text-muted-foreground ml-6 list-disc">
                            ...
                            <li>Percentage: 0.1% of pool (scales with pool size)</li>
                            <li>Purpose: Incentivizes finalization, covers gas costs</li>
                          </ul>
                        </div>
                      </div>

                      <div>
                        <h3 className="font-semibold text-lg mb-3">Prize Distribution Formula</h3>
                        <div className="glass p-6 rounded-xl border border-border/40">
                          <p className="text-muted-foreground mb-3">
                            After finalization, funds are distributed as follows:
                          </p>
                          <ol className="space-y-2 text-sm text-muted-foreground ml-6 list-decimal">
                            <li>
                              <strong>Finalization reward:</strong>{" "}
                              <code className="bg-muted px-1.5 py-0.5 rounded">min(max(0.1% of pool, 0.001 ETH), 0.01 ETH)</code>{" "}
                              (only for expired lotteries)
                            </li>
                            <li>
                              <strong>Creator reward:</strong>{" "}
                              <code className="bg-muted px-1.5 py-0.5 rounded">pool × creator_fee_percentage / 100</code>
                            </li>
                            <li>
                              <strong>Prize pool:</strong>{" "}
                              <code className="bg-muted px-1.5 py-0.5 rounded">pool - finalization_reward - creator_reward</code>
                            </li>
                            <li>
                              <strong>Prize per winner:</strong>{" "}
                              <code className="bg-muted px-1.5 py-0.5 rounded">prize_pool / number_of_winners</code>
                            </li>
                            <li>
                      ...
                      <div>
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                          <div className="glass p-4 rounded-xl border border-green-500/30">
                            <h4 className="font-semibold mb-2 text-green-500">Input Validation</h4>
                          ...
                          <div className="glass p-4 rounded-xl border border-green-500/30">
                            <h4 className="font-semibold mb-2 text-green-500">Access Control</h4>
                            <ul className="text-sm text-muted-foreground space-y-1 ml-4 list-disc">
                          ...
                          <div className="glass p-4 rounded-xl border border-green-500/30">
                            <h4 className="font-semibold mb-2 text-green-500">Fund Safety</h4>
                            <ul className="text-sm text-muted-foreground space-y-1 ml-4 list-disc">
                          ...
                          <div className="glass p-4 rounded-xl border border-green-500/30">
                            <h4 className="font-semibold mb-2 text-green-500">Reentrancy Protection</h4>
                            <ul className="text-sm text-muted-foreground space-y-1 ml-4 list-disc">
                ...
                <TabsContent value="frontend" className="space-y-6">
                  <Card className="glass-strong glow-border p-8 space-y-6">
                    <div className="flex items-center gap-3">
                      ...
                      <h2 className="text-3xl font-bold">Frontend Implementation</h2>
                    </div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        <h3 className="font-semibold text-lg mb-3">Key Components</h3>
                        <div className="space-y-4">
                          <div className="glass p-5 rounded-xl border border-border/40">
                            <h4 className="font-semibold mb-2">
                            ...
                            <p className="text-sm text-muted-foreground mb-2">
                              Manages wallet connection state, provider initialization, and account
                              management. Provides Web3 functionality to all components.
                            </p>
                            <p className="text-xs text-muted-foreground">
                              <strong>Features:</strong> Auto-connect on page load, account change
                              detection, provider switching, disconnect functionality
                            </p>
                          </div>
                          <div className="glass p-5 rounded-xl border border-border/40">
                            <h4 className="font-semibold mb-2">
                              <code className="text-primary">useContract Hook</code>
                            </h4>
                            <p className="text-sm text-muted-foreground mb-2">
                              Custom React hook for interacting with the smart contract. Handles contract
                          ...
                          <div className="glass p-5 rounded-xl border border-border/40">
                            ...
                            <p className="text-xs text-muted-foreground">
                              ...
                              display, finalization button, progress tracking
                            </p>
                          </div>
                          <div className="glass p-5 rounded-xl border border-border/40">
                            <h4 className="font-semibold mb-2">
                            ...
                            <p className="text-sm text-muted-foreground mb-2">
                              ...
                              submission, and displays transaction status.
                            </p>
                            <p className="text-xs text-muted-foreground">
                              <strong>Validation:</strong> Title length, ticket price, end date, number of
                              winners, creator fee, max entrants
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        <h3 className="font-semibold text-lg mb-3">State Management</h3>
                        <div className="glass p-6 rounded-xl border border-border/40">
                          <p className="text-muted-foreground mb-3">
                          ...
                          <ul className="space-y-2 text-muted-foreground ml-6 list-disc">
                            <li>
                              <strong>useState:</strong> Component-level state (lotteries, loading,
                              account)
                            </li>
                            <li>
                              <strong>useContext:</strong> Global Web3 state (provider, account, network)
                            </li>
                            <li>
                              <strong>useMemo:</strong> Computed values (contract instance, filtered
                              lotteries)
                            </li>
                            <li>
                              <strong>useEffect:</strong> Side effects (data loading, event listeners,
                              periodic updates)
                            </li>
                          </ul>
                        </div>
                      ...
                      <div>
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                          <div className="glass p-4 rounded-xl border border-yellow-500/30 bg-yellow-500/10">
                            <h4 className="font-semibold mb-2">Mock Data Fallback</h4>
                            <p className="text-sm text-muted-foreground">
                              If contract is not deployed or wallet is not connected, the app displays
                              mock data to demonstrate functionality. This allows the app to work in demo
                              mode.
                            </p>
                          </div>
                          <div className="glass p-4 rounded-xl border border-yellow-500/30 bg-yellow-500/10">
                            ...
                            <p className="text-sm text-muted-foreground">
                              All contract interactions are wrapped in try-catch blocks. Errors are
                              displayed to users via toast notifications with descriptive messages.
                            </p>
                          </div>
                        </div>
                      </div>
